...
class database
{
    ...
    {
        mysqli_query($this->koneksi, "update tb_barang set nama_barang='$nama_barang',stok='$stok',harga_beli='$harga_beli',harag_jual='$harga_jual' where id_barang='$id_barang'");
    }
